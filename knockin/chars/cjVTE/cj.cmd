...
triggerall = AIlevel >= 7 || random <= (AILevel * 52) && random <= (AILevel * 48)
trigger1 = random<=20
...
triggerall = P2statetype != A && Enemynear,vel y > -1 && !(enemynear, hitfall)
triggerall = AIlevel >= 7 || random <= (AILevel * 52) && random <= (AILevel * 48)
...
value = 3400
triggerall = var(50) && numenemy
triggerall = (power>=2000 && random<=300)
...
value = 3400
triggerall = var(50) && numenemy
triggerall = (power=[1000,2100])||(power>=2000 && random<=300)
triggerall = roundstate = 2 && statetype != A && power >= 1000
triggerall = P2statetype != L && P2statetype != A && Enemynear,vel y > -1 && !(enemynear, hitfall)
triggerall = AIlevel >= 7 || random <= (AILevel * 52) && random <= (AILevel * 48)
trigger1 = (p2dist y = [ -50, 50])
